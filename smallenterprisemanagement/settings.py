"""
Django settings for smallenterprisemanagement project.
...
SECRET_KEY = 'django-insecure-tobavw3t2i6)_4x#1=^*wvw3^m6-9*^+1@uh02l0g%_$nxues%'
...
INSTALLED_APPS = [
    ...
    'generalshop.apps.GeneralshopConfig'
]
